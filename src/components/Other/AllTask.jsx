      ...
      <div className="">
        {userData.map(function (elem, idx) {
          return (
            <div
              key={idx}
              className="py-2 px-4 mb-2 bg-[#2c2c2c] flex justify-between rounded"
            >
              <h2 className="w-1/5 font-bold text-white">{elem.firstName}</h2>
              <h2 className="w-1/5 font-medium text-blue-400">
                {elem.newTask}
              </h2>
              <h2 className="w-1/5 font-medium text-amber-300">
                {elem.activeTask}
              </h2>
              <h2 className="w-1/5 font-medium text-green-400">
                {elem.completedTask}
              </h2>
              <h2 className="w-1/5 font-medium text-red-500">
                {elem.failedTask}
              </h2>
            </div>
          );
