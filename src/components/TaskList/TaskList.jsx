...
const TaskList = () => {
  return (
    <div id='tasklist' className='mt-10 py-5 h-[55%] w-full flex items-center justify-start gap-5 flex-nowrap overflow-x-auto'>
        ...
        <div className='p-5 h-full w-75 bg-green-700 text-sm rounded-xl shrink-0'>
          ...
          <p className='text-sm mt-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores corporis temporibus quasi! Ad, optio nisi.</p>
        </div>
